...
<head>
    ...
    <style>
        ...
        @media screen and (min-width : 358px) and (max-width : 362px)
        {
            ...
            .input-field label[for=register_name], .input-field label[for=register_pwd],.input-field label[for=register_email]{
               margin-left: 47px;
            }
        }
        ...
        @media screen and (min-width : 318px) and (max-width : 322px)
        {
           ...
           h2.title-contact{
            ...
            .input-field label[for=register_name]{
                margin-left: 47px;
            }
        }
...
<body>
    ...
    <form action="register_post.php" method="post">
        ...
        <div class="input-field">
            <input name="register_name" type="text" required>
            <label for="register_name">Votre nom *</label>
        </div>  
         
         <div class="input-field">
            <input name="register_pwd" type="password" required>
            <label for="register_pwd">Votre Mot de passe *</label>
        </div>
    
        <div class="input-field">
            <input name="register_email" type="email" required>
            <label for="register_email">Votre adresse mail *</label>
           </div>
